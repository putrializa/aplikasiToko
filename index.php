...
<!-- Background Video & Header -->
    ...
    <div class="content" id="home"> 
        <nav>
            <img src="./files/logos.png" class="logo" alt="Logo" title="FirstFlight Travels">
            
            <ul class="navbar">
                <li>
                    <a href="#home">Home</a>
                    <a href="#locations">Novel</a>
        ...
        <div class="title">
            <h1>Book Media</h1>
            <p>Ayo cari Buku yang anda cari di website kami!</p>
...
<section class="container">
    <div class="text">
        <h2>Kami memiliki saran buku yang tersedia untuk Anda!</h2>
    </div>
    <div class="rowitems">
